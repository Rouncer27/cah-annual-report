  ...
  const { site, siteLogo, defaultFb } = useStaticQuery(
    graphql`
      query {
        ...
        siteLogo: file(relativePath: { eq: "main-logo.png" }) {
          publicURL
        }
  ...
  return (
    <React.Fragment>
      ...
      <SchemaOrg
        ...
        datePublished="September 29, 2022"
        canonicalUrl="https://annualreport.calgaryadaptedhub.com/"
        author=""
        organization="Calgary Adapted Hub"
        defaultTitle="Calgary Adapted Hub"
      />
    </React.Fragment>
  )
}
